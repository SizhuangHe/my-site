...
```shell
git clone https://github.com/SizhuangHe/my-site
```
...
5) Build a local version of your site by executing `hugo server`. You can see the site by navigating to `http://localhost:1313/my-site/` (actual URL will be outputted in the CLI) in a browser.
...
`hugo.yaml`:
```yaml
baseURL: 'https://SizhuangHe.github.io/my-site'
title: 'Qubt Theme'
```
...
links:
  - github: https://github.com/SizhuangHe/my-site
  - link: https://github.com/SizhuangHe/my-site#readme
...
`https://SizhuangHe.github.io/my-site`